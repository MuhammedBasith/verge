...
// Embedded CSS for minimal custom styles - only inject once
if (!document.querySelector('#ai-prompt-box-styles')) {
const styles = `
  *:focus-visible {
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  return (
      ...
      className={cn(
        "w-full bg-[#44454A] opacity-90 border-[#444444] shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300 ease-in-out",
        className
      )}
      disabled={isLoading}
      ref={ref}
